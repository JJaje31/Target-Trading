...
const Intro = () => {
   ...
   <div className="flex flex-col p-2 justify-center items-center rounded-xl h-80vh w-full bg-gradient-to-r from-gray-400 to to-gray-600  shadow-md ring-1 ring-grey-300 w-100vw text-center">
    <h1 className="mb-10 text-4xl font-bold font-mono text-zinc-50">Target Trading</h1>
      ...
      <div className="flex justify-center mt-20">
        <a href="/SignIn">
<button className="bg-white text-gray-900 px-4 py-2 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 mr-10">
Log In
</button></a>
<a href="/SignUp">
<button className="bg-white text-gray-900 px-4 py-2 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 ml-10">
Get Started
</button>
</a>
</div>
